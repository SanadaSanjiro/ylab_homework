...
import website.ylab.financetracker.in.servlet.adm.GetUsersServlet;
...
class GetUsersServletTest {
    ...
    void doGet() {
        ...
        Mockito.when(service.getAllUsersResponse()).thenReturn(List.of(new UserResponse().setId(id)));
        try (MockedStatic<ServiceProvider> mock = Mockito.mockStatic(ServiceProvider.class)) {
            ...
            new GetUsersServlet().doGet(req, resp);
