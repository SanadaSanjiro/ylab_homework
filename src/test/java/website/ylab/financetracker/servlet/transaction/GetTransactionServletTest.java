...
import website.ylab.financetracker.in.servlet.transaction.GetTransactionServlet;
...
class GetTransactionServletTest {
    long id = 1L;
    ...
    void doGet() {
        ...
        try (MockedStatic<ServiceProvider> mock = Mockito.mockStatic(ServiceProvider.class)) {
            ...
            Mockito.when(service.getById(Mockito.anyLong())).thenReturn(getResponse());
            ...
            new GetTransactionServlet().doGet(req, resp);
