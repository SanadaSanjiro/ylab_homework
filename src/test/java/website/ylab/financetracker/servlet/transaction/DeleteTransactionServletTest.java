...
import website.ylab.financetracker.in.servlet.transaction.DeleteTransactionServlet;
...
class DeleteTransactionServletTest {
    long id = 1L;
    ...
    void doDelete() {
        ...
        try (MockedStatic<ServiceProvider> mock = Mockito.mockStatic(ServiceProvider.class)) {
            ...
            Mockito.when(service.deleteTransaction(Mockito.anyLong())).thenReturn(getResponse());
