package website.ylab.financetracker.in.cli.transaction;
...
public class TransactionDataInput {
    ...
    public String updateTransaction() {
        ...
        String description = getDescription();
        TrackerTransaction transaction = new TrackerTransaction();
        return transactionService.changeTransaction(transaction
                        .setId(id)
                        .setAmount(amount)
                        .setCategory(category)
                        .setDescription(description)).toString();
    ...
    public String deleteTransaction() {
        ...
        long id = getId();
        return transactionService.deleteTransaction(id).toString();
    }
