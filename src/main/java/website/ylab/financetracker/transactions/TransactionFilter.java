...
public class TransactionFilter {
     ...
     */
    public static List<TrackerTransaction> filter(List<TrackerTransaction> list, Date dateFilter) {
     ...
     * @return filtered transaction list
     */
    public static List<TrackerTransaction> filter(List<TrackerTransaction> list, String categoryFilter) {
     ...
     * @return filtered transaction list
     */
    public static List<TrackerTransaction> filter(List<TrackerTransaction> list, TransactionType typeFilter) {
